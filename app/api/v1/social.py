"""Social publishing foundation endpoints; no external delivery is enabled."""
...
from app.services.social_delivery_service import confirm_social_job, prepare_social_job
